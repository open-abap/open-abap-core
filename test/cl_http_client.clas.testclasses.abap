...
CLASS ltcl_test IMPLEMENTATION.
  ...
  METHOD initial_url_path_and_query.
    ...
    cl_http_client=>create_by_url(
      EXPORTING
        url    = |{ lv_host }/anything?sap-client=123|
        ssl_id = 'ANONYM'
      IMPORTING
        client = li_client ).
    ...
    cl_abap_unit_assert=>assert_char_cp(
      act = lv_cdata
      exp = |*"url": "{ lv_host }/anything?sap-client=123&access_token=test-token"*| ).
...
**************
  ...
  METHOD request_uri_with_host.
    ...
    DATA li_client TYPE REF TO if_http_client.
    DATA lv_uri TYPE string VALUE 'https://gist.github.com/larshp/e87684cbef1555b98b97d8ef44d77739'.
